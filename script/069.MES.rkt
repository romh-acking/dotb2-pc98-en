...
(mes
 ...
 (seg*
  ...
  (image-file "B:¥GPC¥DB119.GPC") (image-mem 0 3)
  ...
  (if (</>
       (//
        ...
        (sound '|| 1))))
  (str "Cole: Dead end... No way to go any further.")
  (wait)
  (text-reset 1)
