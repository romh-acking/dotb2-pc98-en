(mes
 ...
 (seg*
  ...
  (text 'br)
  (text "　　　　　　")
  (str " Please select the type of the music board.")
  (text 'br)
  (text 'br)
  (text 'br)
  (text "　　　□")
  (str " Model which music Board is not Built into from the beginning.")
  (text 'br)
  (str
   "                                                     VM･VX･RX･RA etc..")
  (text 'br)
  (text 'br)
  (text "　　　□")
  (str " Model to build music board into main body.")
  (text 'br)
  (str
   "                                                     DX･DS･DA･UX etc..")
  ...
  (text 'br)
  (str
   "        The individual name, the group name, and all know you betters,")
  (text 'br)
  (str "            to which appears, are the one of fictitious.")
  ...
  (text 'br)
  (text 'br)
  (text "　　　この作品は、原作『デッド・オブ・ザ・ブレイン』第７話〔最終話〕の" 'br)
  (text "　　　　　　　　　ストーリーに基づき製作されたものである。")
  (exec-mem 256 2 0 0 0)
  (delay 3)
  ...
  (if (</>
       (//
        ...
        (text 'br)
        (text "　　")
        (str "Prease input the your name.")
