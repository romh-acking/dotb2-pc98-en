...
;
  ...
  (text-reset 0)
;
; 	This is where a lot of essential functions are loaded into memory. If you ever come across (exec-mem [number]) and wonder what it does, you'll find the answer here.
;
...
; ^ These are related to the battles

  (load-mem "A:¥TCM¥DB2COUNT.TCM" 15728)
  (exec-mem 15728 0 0 0 0 0 1 "A:¥CLM¥db2num.dat")
; ^ The timer, used in battles and the room-searching segment in 053.MES
...
; ^ Scroll function (used in 034.MES, 100.MES, 110.MES)

  (load-mem "A:¥TCM¥INPUTNAM.TCM" 21920)
; ^ Used in the name entry segment below

  (load-mem "A:¥TCM¥APPEARH.TCM" 23216)
; ^ Fade animation function (When people turn to skeletons in 109.MES and 111.MES)

  (load-mem "A:¥TCM¥DELTA.TCM" 24896)
; ^ Used to load animations from a WSB file (When Steve is shot in 110.MES, and when Sheila turns around in 112.MES)

  (load-mem "A:¥TCM¥ROLL.TCM" 27088)
; ^ Staff Roll code (112.MES)

  (load-mem "A:¥CLM¥STAFF.DAT" 28032)
; ^ Staff Roll data (112.MES)

  (load-mem "A:¥TCM¥DB2CLS.TCM" 29792)
; ^ Used for room-searching segment (053.MES)
...
;
  ...
  (exec-mem 256 2 0 0 0)  (delay 3)
  (exec-mem 256 2 2 0 0)  (delay 3)
  (exec-mem 256 2 4 0 0)  (delay 3)
  (exec-mem 256 2 6 0 0)  (delay 3)
  (exec-mem 256 2 8 0 0)  (delay 3)
  (exec-mem 256 2 10 0 0) (delay 3)
  (exec-mem 256 2 12 0 0) (delay 200)
  (exec-mem 256 2 12 0 0) (delay 3)
  (exec-mem 256 2 10 0 0) (delay 3)
  (exec-mem 256 2 8 0 0)  (delay 3)
  (exec-mem 256 2 6 0 0)  (delay 3)
  (exec-mem 256 2 4 0 0)  (delay 3)
  ...
  (exec-mem 256 2 0 0 0)    (delay 3)
  (exec-mem 256 2 0 2 2)    (delay 3)
  (exec-mem 256 2 0 4 4)    (delay 3)
  (exec-mem 256 2 0 6 6)    (delay 3)
  (exec-mem 256 2 2 8 8)    (delay 3)
  (exec-mem 256 2 4 10 10)  (delay 3)
  (exec-mem 256 2 6 12 12)  (delay 3)
  (exec-mem 256 2 8 12 12)  (delay 3)
  (exec-mem 256 2 10 12 12) (delay 3)
  (exec-mem 256 2 12 12 12) (delay 300)
  (exec-mem 256 2 12 12 12) (delay 3)
  (exec-mem 256 2 10 10 10) (delay 3)
  (exec-mem 256 2 8 8 8)    (delay 3)
  (exec-mem 256 2 6 6 6)    (delay 3)
  (exec-mem 256 2 4 4 4)    (delay 3)
  (exec-mem 256 2 2 2 2)    (delay 3)
  (exec-mem 256 2 0 0 0)
  (text-reset 0)
  (text-frame 0 0 79 399)
  (text-reset 0)
