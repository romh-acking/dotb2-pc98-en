(mes
 ...
 (seg (? (= P 5) (= 110 #f))
   (text
    "Cole: The horrific funk from these bodies is steaming up theroom. If it stays like this, we're risking an epidemic.")
   (wait)
   (text-reset 1)
   (text
 ...
 (seg (? (= P 5))
   (text
    "Cole: Among the bodies, there are some women... Those       zombies want brains, and they'll attack anyone regardless ofsex.")
   (set-reg 112 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 6) (= 113 #f))
