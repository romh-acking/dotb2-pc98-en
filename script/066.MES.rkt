(mes
 ...
 (seg*
  ...
  (if (</>
       (//
        (? (= 108 #t) (= 121 #f))
        (text "Cole: Doctor Lisle, could I have a glass of water? Sheila is" 'br)
(text "real thirsty...")
        (wait)
        (text-reset 1)
 ...
 (seg (? (= P 5) (= 122 #f))
   ...
   (wait)
   (text-reset 1)
   (text "Lisle: Ah... I had an experiment I had to engage with... I" 'br)
(text "was in the lab adjacent to this room.")
   (wait)
   (text-reset 1)
   (text "Cole: That's the one that's locked by the autolock, right?")
   (wait)
   (text-reset 1)
   (text "Lisle: I'm sorry, Cole, but I can't have anyone entering" 'br)
(text "that lab. There are only two ways in.")
   (wait)
   (text-reset 1)
   (text "Cole: Two ways?")
   (wait)
   (text-reset 1)
   (text "Lisle: One is to enter the autolock PIN. The other is" 'br)
(text "getting the person on the inside to open it for you.")
   (wait)
   (text-reset 1)
   (text "Cole: I see.")
   (set-reg 122 #t)
 ...
 (seg (? (= P 5) (= 123 #f))
   ...
   (wait)
   (text-reset 1)
   (text "Lisle: He made it back okay yesterday. You don't need to" 'br)
(text "worry.")
   (set-reg 123 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 5) (= 124 #f))
   (text "Cole: Doctor Lisle, did you know that Steve had left the" 'br)
(text "building in the middle of the night?")
   (wait)
   (text-reset 1)
   (text "Lisle: !?")
   (wait)
   (text-reset 1)
   (text "Cole: I saw him leaving in the car... carrying something" 'br)
(text "heavy.")
   (wait)
   (text-reset 1)
...
"his room. I thought he was resting...")
   (wait)
   (text-reset 1)
   (text "Lisle: Well, unlike me, he's got plenty on his plate. It's" 'br)
(text "not odd for him to take off in the middle of the night.")
   (wait)
   (text-reset 1)
   ...
   (text-reset 1))
 (seg (? (= P 5))
   (text "Lisle: The detective has a lot to handle, so I don't think" 'br)
(text "it's cause for alarm.")
 ...
 (seg (? (= P 7) (= 125 #f))
   ...
   (wait)
   (text-reset 1)
   (text "Lisle: The Perain Research Institute is one of the top labs" 'br)
(text "around here. We've got the best equipment around.")
   (set-reg 125 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 7) (= 126 #f))
