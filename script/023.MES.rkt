...
(mes
 ...
 (seg (? (= P 5) (= 155 #t) (= 157 #t) (= 160 #t) (= 161 #f))			; Lisle (after inspecting everything) #1
   ...
   (wait)
   (text-reset 1)
   (str "Steve: We had talked about it over the phone.")
   (wait)
   (text-reset 1)
 ...
 (seg (? (= P 5) (= 155 #t) (= 157 #t) (= 160 #t) (= 163 #f))			; Lisle (after inspecting everything) #3
   ...
   (wait)
   (text-reset 1)
   (str "Lisle: He fell into a state of depression, but kept telling" 'br)
   (str "me how he had friends he could trust, to console himself.")
   (wait)
   (text-reset 1)
 ...
 (seg (? (= P 5) (= 155 #t) (= 157 #t) (= 160 #t) (= 166 #f))			; Lisle (after inspecting everything) #6
   ...
   (wait)
   (text-reset 1)
   (str "Lisle: DNV's resilience likely comes Dr. Cooger's" 'br)
