(mes
 ...
 (seg*
  ...
  (if (</>
       (//
        (? (= 169 #f))
        (text "Cole: Okay, so I've climbed the stairs and I'm on the second floor hallway... But no sign of Steve.")
        (wait)
        (text-reset 1)
       ...
       (//
        ...
        (text-reset 1)
        (text
         "Daniel: Since there are still survivors at your precious institute, I figured any of you who showed up would be ready to kill me.")
        (wait)
        (text-reset 1)
        ...
        (text-reset 1)
        (text
         "Daniel: This Purple Sky has been left sitting for three weeks, and will cause complete death 20 minutes after being injected into the bloodstream. I've already tested it on the townspeople.")
        (wait)
        (text-reset 1)
        ...
        (text-reset 1)
        (text
         "Steve: Research!? Refining the reanimation serum into Purple Sky and distributing it through Bloody Fox, causing so much death and misery to the innocent... That's your 'research'?")
        (wait)
        (text-reset 1)
        (text
        ...
        (wait)
        (text-reset 1)
        (text "Daniel: A few sacrifices are always unavoidable. And you get to serve as one yourself!")
        (wait)
        (text-reset 1)
        ...
        (wait)
        (text-reset 1)
        (text "Daniel: I'll deal with you later. For now, just sit back and watch this fool die!")
        (set-reg 170 #t)
        (wait)
        (text-reset 1)
        (sound '|| 2)
