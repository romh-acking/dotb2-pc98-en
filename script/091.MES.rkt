 ...
 (seg*
  ...
  (if (</>
       ...
       (//
        ...
        (wait)
        (text-reset 1)
        (str "Daniel: This Purple Sky has been left sitting for three" 'br)
        (str "weeks, and will cause complete death 20 minutes after being" 'br)
        (str "injected into the bloodstream. I've already tested it on the" 'br)
        (str "townspeople.")
        (wait)
        (text-reset 1)
        ...
        (wait)
        (text-reset 1)
        (str "Steve: Research!? Refining the reanimation serum into Purple" 'br)
