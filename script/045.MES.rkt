(mes
 ...
 (seg*
  ...
  (if (</>
       (//
        (? (= 160 #f))
        (str "Cole: Christ almighty! The stink of death is overpowering. I" 'br)
(str "can't loiter in here.")
        (set-reg 160 #t)
        (wait)
        (text-reset 1))
       (// (str "Cole: I'm inside the Shuffle Food.") (wait) (text-reset 1))))
