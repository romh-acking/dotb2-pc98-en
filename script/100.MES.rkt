...
(str "this thing... How do I escape!?")
  ...
  (menu1
   ...
   51
   317
   (</> (/ (str "Examine Zombie / Punch Zombie / Kick Zombie")) (/ (str "Examine Zombie / Punch Zombie / Kick Zombie")) (/ (str "Examine Zombie / Punch Zombie / Kick Zombie"))))
  (text-reset 1)
  (branch-var
   S
   (</>
