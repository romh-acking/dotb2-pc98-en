(mes
 ...
 (seg (? (= P 5) (= 110 #t) (= 115 #t) (= 124 #t) (= 126 #t))
   ...
   (wait)
   (text-reset 1)
   (text "Cole: It might be Steve. I'll go check things out, but you" 'br)
(text "stay here and rest, okay?")
   (wait)
   (text-reset 1)
 ...
 (seg (? (= P 5) (= 121 #t) (= 110 #f))
   ...
   (wait)
   (text-reset 1)
   (text "Cole: Yeah... Steve told us the military would be here" 'br)
(text "in...well, two days, by this point.")
   (wait)
   (text-reset 1)
   (text "Sheila: How is Catherine doing?")
   (wait)
   (text-reset 1)
   (text "Cole: She's tougher than you'd think, so she'll hold up. I" 'br)
(text "mean, she's not going to be fighting zombies with us or" 'br)
(text "anything...I think.")
   (wait)
   (text-reset 1)
   ...
   (text-reset 1))
 (seg (? (= P 5) (= 121 #t))
   (text "Cole: Sheila, try not to dwell on the incident... Just rest" 'br)
(text "easy if you can.")
   (wait)
   (text-reset 1)
 ...
 (seg (? (= P 5) (= 106 #f))
   ...
   (wait)
   (text-reset 1)
   (text "Sheila: I'm just exhausted. It's fine, I should be able to" 'br)
(text "sleep it off and get better soon...")
   (wait)
   (text-reset 1)
   (text "Cole: You've been through so much. Your body must be under a" 'br)
(text "lot of strain.")
   (set-reg 106 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 5) (= 107 #f))
   ...
   (wait)
   (text-reset 1)
   (text "Sheila: I got up to get some water, but I felt" 'br)
(text "lightheaded...")
   (wait)
   (text-reset 1)
   (text "Cole: Could be stress. I get lightheaded myself when I'm" 'br)
(text "real tired.")
   (wait)
   (text-reset 1)
   (text "Sheila: ...")
 ...
 (seg (? (= P 5) (= 108 #f))
   ...
   (wait)
   (text-reset 1)
   (text "Cole: I see. When stuff like this goes down, it's best to" 'br)
(text "take it easy. Can I get you anything?")
   (wait)
   (text-reset 1)
