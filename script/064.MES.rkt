; Dead of the Brain 2 (PC-98) - 064.MES
...
(mes
 ...
 (seg*
  ...
  (exec-mem 3744 1 5 25 3 40 9)							; 	Sheila
  ...
  (if (</>
       (//
        ...
        (text-reset 1))
       (//
        (str "Cole: Sheila's bedridden. I'm worried.")				; Lead-in from second visit onwards
        (wait)
        (text-reset 1))))
  (loop (exec-mem 3744 3 "P" 32768) (text-color 15) (seg-call)))
 (seg (? (= P 5) (= 110 #t) (= 115 #t) (= 124 #t) (= 126 #t))			; Sheila ()
 ...
 (seg (? (= P 5) (= 121 #t) (= 109 #f))						; Sheila (with water) #1
   ...
   (wait)
   (text-reset 1))
 (seg (? (= P 5) (= 121 #t) (= 110 #f))						; Sheila (with water) #2
   ...
   (wait)
   (text-reset 1)
   (str "Cole: Yeah... Steve told us the military would be here in" 'br)
   (str "...well, two days, by this point.")
   (wait)
   (text-reset 1)
   ...
   (wait)
   (text-reset 1))
 (seg (? (= P 5) (= 121 #t))							; Sheila (with water) #3 (repeat line)
 ...
 (seg (? (= P 5) (= 106 #f))							; Sheila #1
   ...
   (wait)
   (text-reset 1)
   (str "Cole: You've been through so much. Your body must be under" 'br)
   (str "a lot of strain.")
   (set-reg 106 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 5) (= 107 #f))							; Sheila #2
 ...
 (seg (? (= P 5))								; Sheila #4 (repeat line)
   ...
   (wait)
   (text-reset 1))
 (seg (? (= P 1) (= 108 #t) (= 121 #f))						; MOVE (water needed)
   (exec-mem 6064 2 1)
