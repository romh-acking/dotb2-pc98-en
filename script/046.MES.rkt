(mes
 ...
 (seg (? (= P 5) (= 170 #f))
   (text "Cole: Is that really you, Catherine? You made it. Are you" 'br)
(text "hurt?")
   (wait)
   (text-reset 1)
   (text "Catherine: Yes...")
 ...
 (seg (? (= P 5) (= 171 #f))
   ...
   (wait)
   (text-reset 1)
   (text "Catherine: I was so scared... The glass windows broke and" 'br)
(text "all those undead monsters started swarming in...")
   (wait)
   (text-reset 1)
   ...
   (text-reset 1))
 (seg (? (= P 5) (= 172 #f))
   (text "Cole: They've taken over the city. But we're sheltering in a" 'br)
(text "safe place now.")
   (wait)
   (text-reset 1)
   ...
   (wait)
   (text-reset 1)
   (text "Cole: Yeah, it's the Perain Institute. We've got a police" 'br)
(text "detective from the 32nd Precinct and a lab guy named Lisle" 'br)
(text "backing us up.")
   (wait)
   (text-reset 1)
 ...
 (seg (? (= P 5))
   ...
   (wait)
   (text-reset 1)
   (text "Cole: Let's get you up. There's a lab station wagon parked" 'br)
(text "out front.")
   (wait)
   (text-reset 1)
   ...
   (text-reset 1))
 (seg (? (= P 6) (= 174 #f))
   (text "Cole: So you were hiding behind the counter? That's why I" 'br)
(text "couldn't see you.")
   (set-reg 174 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 6) (= 175 #f))
 ...
 (seg (? (= P 6))
   (text
    "Cole: It's amazing you hid there without the zombies finding" 'br)
"you. I figured they could track down their victims even" 'br)
"without sight...")
   (wait)
   (text-reset 1))
 (seg (? (= P 7) (= 176 #f))
 ...
 (seg (? (= P 7) (= 177 #f))
   ...
   (wait)
   (text-reset 1)
   (text "Catherine: Take them. It's not like any customers will be" 'br)
(text "ordering them soon...")
   (wait)
   (text-reset 1)
   ...
   (text-reset 1))
 (seg (? (= P 7))
   (text "Catherine: Cole, you keep looking around all nervously... I" 'br)
(text "was so scared...")
   (wait)
   (text-reset 1)
   (text "Cole: Right...")
