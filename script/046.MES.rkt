(mes
 ...
 (seg (? (= P 5) (= 171 #f))
   ...
   (text-reset 1))
 (seg (? (= P 5) (= 172 #f))
   (text "Cole: They've taken over the city. But we're sheltering in a safe place now.")
   (wait)
   (text-reset 1)
 ...
 (seg (? (= P 6))
   (text
    "Cole: It's amazing you hid there without the zombies finding you. I figured they could track down their victims even without sight...")
   (wait)
   (text-reset 1))
 (seg (? (= P 7) (= 176 #f))
