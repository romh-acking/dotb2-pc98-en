(mes
 ...
 (seg (? (= P 5) (= 105 #f))
   ...
   (text-reset 1)
   (text
    "Cole: My guess is that you discovered something about Purple Sky, and they've been trying to get you ever since.")
   (wait)
   (text-reset 1)
   ...
   (text-reset 1))
 (seg (? (= P 5) (= 106 #f))
   (text "Sheila: When I asked about Purple Sky, someone had mentioned they saw a case stamped with the Razovan Pharmaceuticals logo.")
   (wait)
   (text-reset 1)
   (text "Cole: Razovan?")
   (wait)
 ...
 (seg (? (= P 5) (= 107 #f))
   ...
   (wait)
   (text-reset 1)
   (text "Cole: Bloody Fox used it as bait. They even left bloodstains on it...")
   (wait)
   (text-reset 1)
 ...
 (seg (? (= P 5) (= 109 #f))
   ...
   (text-reset 1)
   (text
    "Cole: That's right, we owe him big. And we need to look into Razovan Pharmaceuticals.")
   (set-reg 109 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 5))
