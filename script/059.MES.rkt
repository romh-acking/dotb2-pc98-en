(mes
 ...
 (seg (? (= P 8) (= 132 #f))
   ...
   (wait)
   (text-reset 1)
   (text "Catherine: I wonder what makes them want to eat brains. What happens once they eat them?")
   (wait)
   (text-reset 1)
   (text "Cole: I dunno. Even if they eat them, they just get digested in their stomach...right?")
   (wait)
   (text-reset 1)
   (text "Catherine: I guess you wouldn't understand unless you become one yourself.")
   (wait)
   (text-reset 1)
 ...
 (seg (? (= P 8))
   ...
   (text-reset 1)
   (text
    "Catherine: Because nobody is better than you at fighting the undead, and if it weren't for you, I'd be sloshing around in some zombie's stomach.")
   (wait)
   (text-reset 1)
