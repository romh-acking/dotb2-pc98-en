(mes
 ...
 (seg (? (= P 5) (= 152 #f))
   ...
   (text-reset 1))
 (seg (? (= P 5) (= 153 #f))
   (text "Cole: The restaurant is silent as the grave. I don't see anymovement.")
   (set-reg 153 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 5))
 ...
 (seg (? (= P 6) (= 154 #f))
   ...
   (text-reset 1))
 (seg (? (= P 6) (= 155 #f))
   (text "Cole: The glass has been shattered. This door is no longer adoor. Now it is...just an opening.")
   (set-reg 155 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 6))
   ...
   (text-reset 1))
 (seg (? (= P 7) (= 156 #f))
   (text "Cole: This is Shuffle Food. The sign's the same one as I sawthe other day.")
   (set-reg 156 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 7))
 ...
 (seg (? (= P 8) (= 158 #f))
   (text
    "Cole: The keys were in the ignition. I don't have time to   fumble around in my pockets every time I'm running away fromthe undead.")
   (set-reg 158 #t)
   (wait)
   (text-reset 1))
