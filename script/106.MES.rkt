(mes
 ...
 (seg*
  ...
  (if (</>
       (//
        (? (= 119 #f))
        (text "Woman's Voice: Ha ha ha ha ha!")
        (wait)
        (text-reset 1)
        (text "Cole: !?" 'br)
        (wait)
        ...
        (text-reset 1))
       (//
        (text "Woman's Voice: Ha ha ha ha haaaa!" 'br)
        (wait)
        (text-reset 1)
        (text "Cole: !?")
        (wait)
        (text-reset 1)
        (text "Man's Voice: *Spit*" 'br)
        (wait)
        (text-reset 1)
        (text "Steve: !?")
        (wait)
 ...
 (seg (? (= P 5) (= 120 #f))
   ...
   (text-reset 1))
 (seg (? (= P 5) (= 121 #f))
   (text "Cole: There's two of them. The last survivors of Bloody Fox?")
   (wait)
   (text-reset 1)
   (text "Steve: Maybe...")
   (set-reg 121 #t)
   ...
   (text-reset 1))
 (seg (? (= P 5) (= 122 #f))
   (text "Cole: I hope Jill's with them...")
   (wait)
   (text-reset 1)
   (text "Steve: Unlikely he'd be hanging out with Bloody Fox.")
   (wait)
   (text-reset 1)
   (text "Cole: Maybe he's hiding somewhere. ")
   (set-reg 122 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 5))
   (text "Cole: They haven't noticed us yet.")
   (wait)
   (text-reset 1)
   (text "Steve: Don't get spotted.")
   (wait)
   (text-reset 1))
 (seg (? (= P 6) (= 123 #f))
   (text "Cole: !?")
   (wait)
   (text-reset 1)
   (text "Steve: Cole, you're going too far... Hide behind a pillar.")
   (wait)
   (text-reset 1)
   (text "Cole: Okay, okay.")
   (set-reg 123 #t)
 ...
 (seg (? (= P 6) (= 124 #f))
   ...
   (text-reset 1))
 (seg (? (= P 6) (= 125 #f))
   (text "Cole: Steve, where are you going?")
   (wait)
   (text-reset 1)
   (text "Steve: Behind that pillar over there.")
   (wait)
   (text-reset 1)
   (text "Cole: ?")
   (wait)
   (text-reset 1)
   (text "Steve: We'll corner them.")
   (set-reg 125 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 6))
