 ...
 (seg*
  ...
  (if (</>
       (//
        ...
        (wait)
        (text-reset 1)
        (text "Cole: Oh, sorry. I was here to see Catherine, I think she" 'br)
(text "works here...")
        (wait)
        (text-reset 1)
        ...
        (if (</>
             ...
             (// (sound '|| "A:¥USO_D¥BR2_07.USO"))))
        (sound '|| 1)
        (text "Cole: Oh, I see! I'm Cole, and I was wondering if you could" 'br)
(text "help me out with something Sheila-related.")
        (wait)
        (text-reset 1)
 ...
 (seg (? (= P 5) (= 192 #f))
   (text
    "Catherine: This is Shuffle Food, where I'm putting in the" 'br)
"hours... We never really get a break and we're understaffed," 'br)
"so I'm here almost every day.")
   (set-reg 192 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 5) (= 193 #f))
   ...
   (text-reset 1)
   (text
    "Catherine: I'm on break. I was about to clean the front, and" 'br)
"I noticed someone outside looking confused, so I went over" 'br)
"to say hi.")
   (set-reg 193 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 5))
   ...
   (wait)
   (text-reset 1)
   (text "Catherine: Today's a holiday, so...on weekdays we're not" 'br)
(text "usually this slammed.")
   (wait)
   (text-reset 1))
 (seg (? (= P 6) (= 194 #f))
 ...
 (seg (? (= P 7) (= 195 #f))
   (text "Catherine: The sign really stands out. I guess you can see" 'br)
(text "it from the road.")
   (set-reg 195 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 7) (= 196 #f))
   ...
   (text-reset 1))
 (seg (? (= P 7))
   (text "Cole: That's the big sign that reads 'Shuffle Food,'" 'br)
(text "whatever that means.")
   (wait)
   (text-reset 1))
 (seg (? (= P 8) (= 197 #f))
   (text "Cole: I'd heard about you from Sheila, but Catherine, you're" 'br)
(text "cuter than described.")
   (wait)
   (text-reset 1)
   (text "Catherine: Wow, smooth talker. Did you use the same lines" 'br)
(text "when you were flirting with Sheila?")
   (wait)
   (text-reset 1)
 ...
 (seg (? (= P 8) (= 198 #f))
   ...
   (wait)
   (text-reset 1)
   (text "Cole: I called early this afternoon, but no answer. I went" 'br)
(text "to her apartment earlier, but...")
   (wait)
   (text-reset 1)
 ...
 (seg (? (= P 8) (= 199 #f))
   ...
   (wait)
   (text-reset 1)
   (text "Cole: I'm not sure, and Sheila isn't there... I thought you" 'br)
(text "might know something.")
   (wait)
   (text-reset 1)
 ...
 (seg (? (= P 8))
   ...
   (wait)
   (text-reset 1)
   (text "Catherine: Well, I don't know if this helps, but we went to" 'br)
(text "a disco once.")
   (wait)
   (text-reset 1)
   ...
   (text-reset 1)
   (text
    "Catherine: Back then Sheila was drinking and getting super" 'br)
"buzzed a ton... But then she started going to that disco.")
   (wait)
   (text-reset 1)
   (text "Cole: By herself?")
   (wait)
   (text-reset 1)
   (text "Catherine: No, she's been inviting me. But you know, that" 'br)
(text "disco's had a reputation as a drug dealer hangout for a long" 'br)
(text "time.")
   (wait)
   (text-reset 1)
   ...
   (text-reset 1)
   (text
    "Catherine: Yeah. Heroin, speed, weed, rush, that kind of" 'br)
"thing. Apparently dealers even showed up at Sheila's place" 'br)
"back then, though she'd just brush them off.")
   (wait)
   (text-reset 1)
   (text "Cole: Heroin, huh... So where is this disco?")
   (wait)
   (text-reset 1)
   (text "Catherine: It's nearby. It's called Zeena, it's quite the" 'br)
(text "hotspot.")
   (wait)
   (text-reset 1)
   ...
   (wait)
   (text-reset 1)
   (text "Catherine: Go straight down that road to the mailbox, then" 'br)
(text "take a left. It's the fourth building on that side.")
   (wait)
   (text-reset 1)
   (text "Cole: Got it. Thank you... I'll go there right now.")
   (wait)
   (text-reset 1)
   (text "Catherine: Be careful, Cole. There are guys there who are" 'br)
(text "just looking for a fight.")
   (wait)
   (text-reset 1)
   (text "Cole: Yeah, I got it. Thanks, Cassie.")
   (wait)
   (text-reset 1)
   (text "Catherine: Now it's Cassie, huh? Sheila was right, you" 'br)
(text "really are a charmer.")
   (wait)
   (text-reset 1)
   (sound '|| 2)
