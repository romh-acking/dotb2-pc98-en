(mes
 ...
 (seg (? (= P 7))
   ...
   (text-reset 1))
 (seg (? (= P 8) (= 197 #f))
   (text "Cole: I'd heard about you from Sheila, but Catherine, you'recuter than described.")
   (wait)
   (text-reset 1)
 ...
 (seg (? (= P 8))
   ...
   (wait)
   (text-reset 1)
   (text "Catherine: No, she's been inviting me. But you know, that   disco's had a reputation as a drug dealer hangout for a longtime.")
   (wait)
   (text-reset 1)
