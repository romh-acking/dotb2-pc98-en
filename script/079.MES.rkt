(mes
 ...
 (seg (? (= P 5) (= 128 #f))
   (text "Sheila: Cole... Stop staring off into the distance like" 'br)
(text "that.")
   (set-reg 128 #t)
   (wait)
   (text-reset 1))
 ...
 (seg (? (= P 7) (= 130 #f))
   ...
   (wait)
   (text-reset 1))
 (seg (? (= P 7)) (text "Cole: I need to stop looking at the desk, or Sheila will" 'br)
(text "call me out.") (wait) (text-reset 1))
 (seg (? (= P 8) (= 131 #f))
   ...
   (wait)
   (text-reset 1)
   (text "Cole: ...It's not like I could understand any of their" 'br)
(text "complicated medical terms...")
   (wait)
   (text-reset 1)
 ...
 (seg (? (= P 8) (= 132 #f))
   ...
   (wait)
   (text-reset 1)
   (text "Cole: Could you leave me alone for a minute? I have a lot to" 'br)
(text "think about...")
   (wait)
   (text-reset 1)
   ...
   (wait)
   (text-reset 1)
   (text "Cole: God, would you just shut up for once! I told you to" 'br)
(text "go!")
   (wait)
   (text-reset 1)
   (text "Sheila: ...")
   ...
   (text-reset 1))
 (seg (? (= P 8) (= 133 #f))
   (text "Sheila: Cole... Do you hate me now because I got...sick..." 'br)
(text "Because I'm going to turn?")
   (wait)
   (text-reset 1)
 ...
 (seg (? (= P 8))
   ...
   (text "Sheila: So that's why. I get it now. Lisle told you he" 'br)
(text "couldn't cure me, right?")
   (wait)
   (text-reset 1)
...
"put a bullet in me to stop the inevitable, don't you?")
   ...
   (wait)
   (text-reset 1)
   (text "Cole: I get how you feel, Sheila... You know that if I could" 'br)
(text "cure you, I would...")
   (wait)
   (text-reset 1)
   (text "Cole: ...But to do that, we have to revive Doc. And the" 'br)
(text "chances aren't good that he's still all there...")
   (wait)
   (text-reset 1)
   (text "Cole: And if we can't revive him or something awful happens," 'br)
(text "I couldn't face you, or Doc, with a clear conscience...")
   (wait)
   (text-reset 1)
   (text "Cole: Even before,  I never would have thought of doing something as cruel as reviving Doc...")
   (wait)
   (text-reset 1)
   (text "Cole: But if things keep going the way they are... Just like" 'br)
(text "Sheila said, I might have to pull the trigger on her.")
   (wait)
   (text-reset 1)
   (text
...
"save Sheila at any cost.")
          (wait)
          (text-reset 1)
          (text "Cole: And even if things go horribly wrong, what matters is" 'br)
(text "we tried.")
          (wait)
          (text-reset 1)
          (text "Cole: I'm going to go tell Lisle and the others.")
