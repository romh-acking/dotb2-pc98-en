(mes
 ...
 (seg (? (= P 8) (= 132 #f))
   ...
   (wait)
   (text-reset 1)
   (text "Cole: Could you leave me alone for a minute? I have a lot tothink about...")
   (wait)
   (text-reset 1)
 ...
 (seg (? (= P 8))
   ...
   (text-reset 1)
   (text
    "Sheila: Yes it is! And when I turn, you're going to have to shoot me, right? No matter how much you love me, you have toput a bullet in me to stop the inevitable, don't you?")
   (wait)
   (text-reset 1)
   ...
   (wait)
   (text-reset 1)
   (text "Cole: I get how you feel, Sheila... You know that if I couldcure you, I would...")
   (wait)
   (text-reset 1)
   ...
   (wait)
   (text-reset 1)
   (text "Cole: But if things keep going the way they are... Just likeSheila said, I might have to pull the trigger on her.")
   (wait)
   (text-reset 1)
   (text
