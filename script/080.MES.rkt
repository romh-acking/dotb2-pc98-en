(mes
 ...
 (seg (? (= P 5) (= 140 #t))
   ...
   (text-reset 1))
 (seg (? (= P 5) (= 138 #t))
   (text "Lisle: I'll give my all in resuscitating his brain to ensurethat you made the right decision.")
   (wait)
   (text-reset 1)
 ...
 (seg (? (= P 6) (= 143 #t))
   ...
   (text-reset 1)
   (text
    "Cole: Yes. When they were trying to abduct Catherine from   Shuffle Food, one of the Bloody Fox members said they'd takeher to Razovan.")
   (wait)
   (text-reset 1)
   ...
   (wait)
   (text-reset 1)
   (text "Steve: If we're going to infiltrate the building, we'll needto prep.")
   (wait)
   (text-reset 1)
   (if (</>
        (//
 ...
 (seg (? (= P 6) (= 138 #t) (= 142 #f))
   ...
   (text-reset 1))
 (seg (? (= P 6) (= 138 #t))
   (text "Steve: Either way, it must have been a tough decision... Butit's one you made with your heart.")
   (wait)
   (text-reset 1)
   (text "Cole: ...")
   (wait)
   (text-reset 1))
 (seg (? (= P 6) (= 140 #t))
   (text "Steve: Whatever your decision, Cole, I hope it turns out forthe best.")
   (wait)
   (text-reset 1))
 (seg (? (= P 6))
