...
(mes
 ...
 (seg*
  ...
  (wait)
  (text-reset 1)
  (str "Cole: That's Sheila's voice! No time to lose!")
  (wait)
  (text-reset 1)
  (exec-mem 9920 0 6 6 113 64 0)
  (image-file "B:¥GPC¥DB035.GPC") (image-mem 0 3)
  (exec-mem 912 "INIT,A 0,S 0,O 0,D 1")
  (exec-mem 912 "C 0 2 23 40 238 1 2 23")
  (exec-mem 912 "C 0 40 23 18 238 1 40 23")
  (exec-mem 912 "A 1")
  (image-file "B:¥GPC¥DB037.GPC") (image-mem 0 3)
  (exec-mem 912 "GET 0 2 23 54 238")
  (image-file "B:¥GPC¥DB037A.GPC") (image-mem 0 3)
  (exec-mem 912 "GET 1 2 23 54 238")
  (image-file "B:¥GPC¥DB037B.GPC") (image-mem 0 3)
  ...
  (sound '|| 1)
  (str "B.F.: Heh heh heh... You enjoyin' the Purple Sky?")
  (wait)
  (text-reset 1)
  (str "B.F.: It'll make ya feel real good, sis!")
  (wait)
  (text-reset 1)
  (str "Sheila: Nooo!")
  (wait)
  (text-reset 1)
  (str "Cole: Those fuckers! How dare you... How dare you touch her!")
  (wait)
  (text-reset 1)
  (str "Sheila: Cole!!!")
  (wait)
  (text-reset 1)
  (str "B.F.: Looks like we've got another customer!")
  (wait)
  (text-reset 1)
  (str "Cole: You aren't getting away with this!")
  (wait)
  (text-reset 1)
  ...
  (image-file "B:¥GPC¥DB036.GPC") (image-mem 0 3)
  (exec-mem 15456 0)
  (exec-mem 9920 1 6 32 113 32 6 6 113 64 8 50)
  ...
  (if (</>
       ...
       (//
        ...
        (wait)
        (text-reset 1)
        (str "B.F.: You're a hundred years too early to take us down!")
        (wait)
        (text-reset 1)
        (str "B.F.: Pickin' a fight with Bloody Fox? What an idiot!")
        (wait)
        (text-reset 1)
        (exec-mem 17408 3)
  ...
  (if (</>
       (//
        ...
        (exec-mem 912 "PUT 1 2 23,W 0,O 0") (delay 4 0)
        ...
        (text-reset 1)
        (exec-mem 9920 2 6 6 113 64 6 32 113 32 0 50)
        (str "Cole: Count your blessings that you weren't killed...")
        (wait)
        (text-reset 1)
        (exec-mem 17408 3)
        (exec-mem 256 3 0 11 0)
        ...
        (wait)
        (text-reset 1)
        (image-file "B:¥GPC¥DB038.GPC") (image-mem 0 3)
        (exec-mem 9920 1 6 32 113 32 6 6 113 64 8 50)
        (sound '|| 0)
        (if (</>
        ...
        (sound '|| 1)
        (str "Sheila: Cole... I... was so worried about you...")
        (wait)
        (text-reset 1)
        (str "Cole: It's all right now.")
        (wait)
        (text-reset 1)
        (str "Sheila: Purple Sky...they injected me with it...")
        (wait)
        (text-reset 1)
        (str "Cole: It's okay, it's just a drug. You don't need to worry" 'br)
        (str "if it's just one dose.")
        (wait)
        (text-reset 1)
        (str "Sheila: I'm so sorry...")
        (wait)
        (text-reset 1)
        (str "Cole: Come on, let's go home.")
        (wait)
        (text-reset 1)
        (sound '|| 2)
        (exec-mem 9920 2 6 6 113 64 6 32 113 32 0 50)
        (str "Cole: I took Sheila home and told her all the information" 'br)
        (str "I'd gathered.")
        (wait)
        (text-reset 1)
        (str "Cole: Sheila was in shock, so after I finished talking with" 'br)
        (str "her, I went home and collapsed onto my bed.")
        (wait)
        (text-reset 1)
        (str "Cole: Purple Sky... Just who is manufacturing the" 'br)
        (str "reanimation serum?")
        (wait)
        (text-reset 1)
        (str "Cole: Anyway, I'm worried about Sheila getting that Purple" 'br)
        (str "Sky injection. I should meet with Steve again tomorrow and" 'br)
        (str "get more details...")
        (wait)
        (text-reset 1)
        (str "Cole: For Sheila's sake, and Doc's too...")
        (wait)
        (text-reset 1)
        (sound '|| 0)
