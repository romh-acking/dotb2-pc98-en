(mes
 ...
 (seg (? (= P 5) (= 147 #f))
   ...
   (wait)
   (text-reset 1)
   (text "Cole: He said the blood test results would take a bit, but" 'br)
(text "you should be just fine, considering how peppy you are.")
   (wait)
   (text-reset 1)
   (text "Sheila: Peppy...?")
   (wait)
   ...
   (wait)
   (text-reset 1)
   (text "Sheila: It's just... I've been thinking all this time, what" 'br)
(text "are we gonna do next?")
   (wait)
   (text-reset 1)
   (text "Cole: We've got this covered. We'll catch whoever's using" 'br)
(text "Doc's serum.")
   (wait)
   (text-reset 1)
...
"have been a cakewalk.")
   ...
   (text-reset 1))
 (seg (? (= P 5) (= 149 #f))
   (text "Sheila: Lisle doesn't seem to hold the reanimation serum in" 'br)
(text "very high regard.")
   (wait)
   (text-reset 1)
   (text "Cole: I guess not, though he does respect how Doc unraveled" 'br)
(text "a buncha mysteries of the human brain.")
   (wait)
   (text-reset 1)
   (text "Sheila: What's in our heads is really unfathomable, isn't" 'br)
(text "it?")
   (set-reg 149 #t)
   (wait)
   (text-reset 1))
...
"there together before...")
   ...
   (wait)
   (text-reset 1)
   (text "Cole: Yeah, Steve had me look up the address... Uh, Sheila," 'br)
(text "what's wrong?")
   (wait)
   (text-reset 1)
   (text "Sheila: !!")
...
"area...")
 ...
 (seg (? (= P 6) (= 111 #f))
   ...
   (wait)
   (text-reset 1)
   (text "Sheila: Looks like a shower room... The lab has lots of" 'br)
(text "places for rest breaks.")
   (set-reg 111 #t)
   (wait)
   (text-reset 1))
...
"at home. Don't knock it, it's comfy.")
 ...
 (seg (? (= P 8) (= 115 #f))
   ...
   (wait)
   (text-reset 1))
 (seg (? (= P 8)) (text "Sheila: The curtains are closed. It gets cold at night," 'br)
(text "after all.") (wait) (text-reset 1))
 (seg (? (= P 1))
   (exec-mem 6064 2 1)
