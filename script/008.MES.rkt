(mes
 ...
 (seg (? (= P 5))
   ...
   (wait)
   (text-reset 1)
   (text "B.F.: Whu? You think a little pea-shooter like that's gonna spook us?")
   (wait)
   (text-reset 1)
   (text "Woman: Help me!!!")
   (wait)
        ...
        (//
         ...
         (if (</>
              ...
              (//
               ...
               (image-mem 1 3)
               (exec-mem 9920 1 6 32 113 32 6 6 113 64 8 50)
               (text "B.F.: You're quick, I'll give you that... But now it's time for you to join the CLUB!")
               (wait)
               (text-reset 1)
               ...
               (text-reset 1)
               (text
                "B.F.: How should I know? After we beat the shit out of him, he won't cross Bloody Fox again.")
               (wait)
               (text-reset 1)
