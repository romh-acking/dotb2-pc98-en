   ...
   (if (</>
        (//
         ...
         (branch-random
          (</>
           (/
             (text "You're a hundred years too early to be pickin' a" 'br)
             (text "fight with Bloody Fox!"))
           (/
             (text "Tell your friends about how tough Bloody Fox is..." 'br)
             (text "Tell them...IN HELL!"))))
         (wait)
         (text-reset 1)
         (exec-mem 17408 3)
        ...
        (//
         ...
         (if (</>
              ...
              (//
               ...
               (wait)
               (text-reset 1)
               (text "B.F.: So who was that dude packing heat? He was asking" 'br)
               (text "about Purple Sky...you figure he's a pig?")
               (wait)
               (text-reset 1)
               (text "B.F.: How should I know? After we beat the shit out of him," 'br)
               (text "he won't cross Bloody Fox again.")
               (wait)
               (text-reset 1)
               (text "B.F.: Ha ha ha...ain't that the truth!")
               (wait)
               (text-reset 1)
               (text "B.F.: But that fucker just wasted our last dose of Purple" 'br)
               (text "Sky. We gotta go restock.")
               (wait)
               (text-reset 1)
               ...
               (wait)
               (text-reset 1)
               (text "Cole: But they were talking about drugs, right? So the" 'br)
               (text "stuff they had wasn't the reanimation serum, it was just" 'br)
               (text "typical street junk, right...?")
               (wait)
               (text-reset 1)
               (text "Cole: I've never heard of a drug called Purple Sky.")
               (wait)
               (text-reset 1)
               (text "Cole: Anyway, no point sitting around. I should head" 'br)
               (text "home... Sheila's probably worried sick.")
               (wait)
               (text-reset 1)
               (text "Cole: Huh?")
               (wait)
               ...
               (text "Cole: A matchbook... one of them must have dropped it." 'br)
               (text "Might come in handy later.")
               (wait)
               (text-reset 1)
