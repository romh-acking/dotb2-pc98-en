...
(mes
 ...
 (seg*
  (loop
   ...
   (text-reset 0)
   (menu1
    2 300  11 300  20 300  29 300  38 300  47 300  56 300  65 300
    2 320  11 320  20 320  29 320  38 320  47 320  56 320  65 320  0 0
    (</>
     (/ (str " BR2_01 "))
     (/ (str " BR2_02 "))
     (/ (str " BR2_03 "))
 ...
 (seg (? (= T 5))
   ...
   (loop
    (text-frame 2 284 78 340)
    (text-reset 0)
    (menu1  2 320  11 320  20 320  29 320  38 320  47 320  56 320  65 320
     (</>
      (/ (str " BR1_01 "))
      (/ (str " BR1_02 "))
      (/ (str " BR1_03 "))
