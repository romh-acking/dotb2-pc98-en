...
(mes
 ...
 (seg*
  ...
  (image-file "B:¥GPC¥DB022.GPC") (image-mem 1 3)
 ...
 (seg (? (= P 5) (= 196 #f))							; Sign #1
   ...
   (wait)
   (text-reset 1)
   (str "Cole: The newspaper article said that the culprit, Ben" 'br)
   (str "Raymond, was a junkie...")
   (wait)
   (text-reset 1)
   (str "Cole: A junkie who was able to kill seven people without" 'br)
   (str "anyone stopping him.")
   (set-reg 196 #t)
   (wait)
   (text-reset 1))
 ...
 (seg (? (= P 7) (= 200 #f))							; Bloody Fox #1
   ...
   (wait)
   (text-reset 1)
   (str "Cole: Hey pal, do you know what happened here yesterday?")
   (wait)
   (text-reset 1)
   (str "B.F.: I don't care how many times you ask, I wasn't here" 'br)
   (str "yesterday. I don't know nuffin'. Heh heh heh...")
   (wait)
   (text-reset 1)
   (str "Cole: Who was here?")
   (wait)
   (text-reset 1)
   (str "B.F.: I said I don't know nuffin', especially when a piggie" 'br)
   (str "is askin'. Heh heh heh... Oink oink...")
   (set-reg 200 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 7) (= 201 #f))							; Bloody Fox #2
   ...
   (wait)
   (text-reset 1)
   (str "Cole: Was Ben in Bloody Fox?")
   (wait)
   (text-reset 1)
   (str "B.F.: Beats me. I wasn't in yesterday. Had important things" 'br)
   (str "to do.")
   (wait)
   (text-reset 1)
   (str "Cole: You sure? You're looking pretty shitfaced.")
   (wait)
   (text-reset 1)
   (str "B.F.: Heh heh heh heh...")
   (set-reg 201 #t)
 ...
 (seg (? (= P 7) (= 202 #f))							; Bloody Fox #3
   ...
   (wait)
   (text-reset 1)
   (str "Cole: No time like the present.")
   (wait)
   (text-reset 1)
   (str "B.F.: How is anyone this stupid? You're gonna get thrashed" 'br)
   (str "within an inch of your life, pal.")
   (wait)
   (text-reset 1)
   (str "Cole: I'm not here to throw down, I just wanna ask your" 'br)
   (str "buddies about what happened yesterday.")
   (wait)
   (text-reset 1)
   (str "B.F.: Get a load of this guy! Man, you come right out of a" 'br)
   (str "comic book. Heh heh heh...")
   (set-reg 202 #t)
   (wait)
   (text-reset 1))
