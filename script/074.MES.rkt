(mes
 ...
 (seg*
  ...
  (loop
   ...
   (text-reset 1)
   (text "Cole: Okay, where should I go next?")
   (exec-mem 3744 3 "P" 32768)
   (text-color 15)
   (text-reset 1)
   (seg-call)))
 (seg (? (= P 5))
   (text "Cole: This is the room where I'm staying.")
   (wait)
   (text-reset 1)
   (sound '|| 2)
 ...
 (seg (? (= P 6))
   (text "Cole: There was a DNV reaction in Sheila's blood, huh...")
   (wait)
   (text-reset 1)
   (sound '|| 2)
   (exec-mem 9920 2 6 6 113 64 6 32 113 32 0 50)
 ...
 (seg (? (= P 8)) (text "Cole: This door's locked. I can't get in.") (wait) (text-reset 1))
 (seg (? (= P 9) (= 116 #t) (= 124 #t))
   (text "Cole: Let's try going to the lab.")
   (wait)
   (text-reset 1)
   (sound '|| 2)
   (exec-mem 9920 2 6 6 113 64 6 32 113 32 0 50)
