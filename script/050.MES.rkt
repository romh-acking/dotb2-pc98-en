...
(mes
 ...
 (seg (? (= P 8) (= 196 #f))							; Catherine #1
   ...
   (wait)
   (text-reset 1)
   (str "Cole: It's can't be helped that your mother wound up" 'br)
   (str "falling for Daniel. But I can't forgive him for using the" 'br)
   (str "reanimation serum to kill innocents.")
   (wait)
   (text-reset 1)
