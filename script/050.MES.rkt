...
(str "told Sheila.")
        (wait)
        (text-reset 1)
        (str "Catherine: I've never told anyone else about my...situation." 'br)
(str "But Sheila is a close friend.")
        (wait)
        (text-reset 1)
        (str "Cole: I see.")
        (wait)
        ...
        (wait)
        (text-reset 1))
       (// (str "Catherine: Cole, what's wrong?") (wait) (text-reset 1))))
...
(str "since the action earlier?")
   (wait)
   (text-reset 1)
   (str "Catherine: Yeah, I'm okay now. But aside from that, about my" 'br)
(str "stepfather, Daniel...")
   (wait)
   (text-reset 1)
   (str "Cole: There's no doubt about it. Daniel resurrected the dead" 'br)
(str "with the reanimation serum.")
   (wait)
   (text-reset 1)
...
"serum to kill innocents.")
   ...
   (text-reset 1))
 (seg (? (= P 8) (= 197 #f))
   (str "Cole: I feel like I understand how painful this has been for" 'br)
(str "you...")
   (wait)
   (text-reset 1)
   (str "Catherine: ...Yeah...")
...
(str "her be for a while.")
   ...
   (text-reset 1))
 (seg (? (= P 5) (= 199 #f))
   (str "Cole: Judging by how the sheets have been moved, Catherine's" 'br)
(str "been sitting here for quite some time.")
   (wait)
   (text-reset 1)
...
(str "don't catch cold.")
   (set-reg 200 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 6)) (str "Catherine: The curtains can stay open.") (wait) (text-reset 1))
 (seg (? (= P 7) (= 201 #f))
   (str "Catherine: I finally changed the calendar since it was still" 'br)
(str "on July.")
   (set-reg 201 #t)
   (wait)
   (text-reset 1))
