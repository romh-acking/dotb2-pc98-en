(mes
 ...
 (seg (? (= P 8) (= 196 #f))
   ...
   (wait)
   (text-reset 1)
   (text "Catherine: Yeah, I'm okay now. But aside from that, about my stepfather, Daniel...")
   (wait)
   (text-reset 1)
   (text "Cole: There's no doubt about it. Daniel resurrected the dead with the reanimation serum.")
   (wait)
   (text-reset 1)
   ...
   (text-reset 1))
 (seg (? (= P 8) (= 197 #f))
   (text "Cole: I feel like I understand how painful this has been for you...")
   (wait)
   (text-reset 1)
   (text "Catherine: ...Yeah...")
   (wait)
 ...
 (seg (? (= P 8))
   ...
   (text-reset 1))
 (seg (? (= P 5) (= 199 #f))
   (text "Cole: Judging by how the sheets have been moved, Catherine's been sitting here for quite some time.")
   (wait)
   (text-reset 1)
 ...
 (seg (? (= P 7) (= 201 #f))
   (text "Catherine: I finally changed the calendar since it was still on July.")
   (set-reg 201 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 7))
