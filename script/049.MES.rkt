; Dead of the Brain 2 (PC-98) - 049.MES
; Translated by Geometrizer
; Edited by JackDBS, commented by trentsignia
; -----Scene:-----
; Cole checks in on Sheila in her room after rescuing Catherine.
; --Progression:--
; Talk to Sheila after talking to Lisle.
; -----Quiz:-----
; 1. Briar
; 2. Disco Zeena
...
(mes
 ...
 (seg*
  ...
  (if (</>
       (//
        (? (= 184 #f) (= 202 #f))						; Lead-in for first visit (if Catherine hasn't already been visited in her room)
        ...
        (text-reset 1))
       (//
        (str "Sheila: What's the matter, Cole? You seem...unsettled" 'br)	; Lead-in from second visit onwards
        (str "today. You usually hold it together better than I do.")
        (wait)
        (text-reset 1))))
  (loop (exec-mem 3744 3 "P" 32768) (text-color 15) (seg-call)))
 (seg (? (= P 5) (= 182 #t) (= 186 #t) (= 187 #f))				; Sheila (After talking to Lisle)
   ...
   (wait)
   (text-reset 1)
   (str "Sheila: First of all, there's no doubt that Bloody Fox is" 'br)	; Quiz begins here...
   ...
   (wait)
   (text-reset 1)
   (str "Sheila: And amongst Bloody Fox, the person most connected" 'br)	; Question 1
   (str "to Purple Sky is...")
   (wait)
   (text-reset 1)
   (menu1
    16 298  36 298  56 298
    16 317  36 317  56 317
    16 337  36 337  56 337
    (</>
   ...
   (wait)
   (text-reset 1)
   (str "Sheila: Razovan was raided a while back for violating the" 'br)	; Question 4
   ...
   (wait)
   (text-reset 1)
   (str "Sheila: Now, what's the name of Razovan's director, who is" 'br)	; Question 5
   ...
   (wait)
   (text-reset 1)
   (str "Sheila: What did they say to try to lure Catherine out?")		; Question 6
   (wait)
   (text-reset 1)
   (menu1
    16 298
   ...
   (if (</>
        (//
         (? (= 188 #t) (= 189 #t) (= 190 #t) (= 191 #t) (= 192 #t) (= 193 #t))	; Correct answers
         (str "Cole: Now that we've pieced all these together, it's almost" 'br)
         (str "certain that Razovan Pharmaceuticals and Bloody Fox are" 'br)
         (str "connected.")
         (set-reg 187 #t)
         (wait)
         (text-reset 1))
        (//
         (str "Cole: Something still feels off, though...")			; Wrong answer(s)
         (wait)
         (text-reset 1)
         ...
         (text-reset 1)
         ((cmd 204) 188 193)))))
 (seg (? (= P 5) (= 182 #t) (= 186 #t))						; Sheila (After reflecting on events) (repeat line)
 ...
 (seg (? (= P 5) (= 185 #f))							; Sheila #1
   (str "Sheila: So Catherine's stepfather is the director of" 'br)
   (str "Razovan Pharmaceuticals... She must feel awful about all of" 'br)
   (str "this.")
   (wait)
   (text-reset 1)
