(mes
 ...
 (seg (? (= P 5) (= 104 #t) (= 106 #t) (= 107 #t))
   ...
   (text-reset 1)
   (text "To Cole" 'br)
   (text "Since I'll be getting home late anyway, I'm going to come   and look for you. If you beat me back, just wait for me -- Ipromise I'll be there. --Sheila")
   (wait)
   (text-reset 1)
 ...
 (seg (? (= P 7) (= 102 #f))
   (text
    "Cole: The AC unit is off. The weather's been nice lately, soit's been off for months.")
   (set-reg 102 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 7))
 ...
 (seg (? (= P 8))
   ...
   (text-reset 1))
 (seg (? (= P 9) (= 105 #f))
   (text "Cole: The door was locked when I came back. Since Sheila hasmy spare key, she probably locked it for safety's sake.")
   (set-reg 105 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 9) (= 106 #f))
   (text
    "Cole: It's too late to go out again. When the sun comes up  tomorrow I'll head back into the city to look for Purple Skyagain.")
   (set-reg 106 #t)
   (wait)
   (text-reset 1))
 (seg (? (= P 9))
