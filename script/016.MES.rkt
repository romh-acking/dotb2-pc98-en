(mes
 ...
 (seg (? (= P 5) (= 104 #t) (= 106 #t) (= 107 #t))
   ...
   (text-reset 1)
   (str "To Cole" 'br)
   (str "Since I'll be getting home late anyway, I'm going to come" 'br)
   (str "and look for you. If you beat me back, just wait for me -- I" 'br)
   (str "promise I'll be there. --Sheila")
   (wait)
   (text-reset 1)
